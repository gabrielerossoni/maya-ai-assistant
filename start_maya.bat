...
:: 1. Avvio/Verifica Ollama (Porta 11434)
...
echo [!] In attesa che il motore AI risponda...
set retry=0
...
set /a retry=%retry%+1
if %retry% geq 15 goto ollama_error
goto wait_ollama
...
:ollama_error
echo [ERR] Ollama non risponde dopo 30 secondi.
pause
exit /b
